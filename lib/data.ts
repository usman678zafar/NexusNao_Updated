...
export const caseStudies = [
    ...
    },
    {
        ...
        challenge: "Inefficient route planning and lack of real-time tracking led to high fuel costs and delayed deliveries.",
        approach: "We developed a centralized dashboard with GPS integration and AI-driven route optimization algorithms.",
        solution: "A comprehensive logistics platform that tracks fleet movements and optimizes delivery routes in real-time.",
        results: [
        ...
        testimonial: {
            quote: "The route optimization is a game-changer. We've saved significantly on fuel and our drivers are happier.",
            author: "Michael Chen",
            role: "Operations Director",
        },
        stack: ["React", "Node.js", "MongoDB", "Google Maps API"],
        timeline: "10 Months",
        team: "8 Engineers, 2 UI/UX Designers",
    },
]
