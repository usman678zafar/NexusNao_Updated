...
export function Metrics() {
  return (
    <section className="py-20 bg-neutral-950 border-y border-neutral-900 relative overflow-hidden mx-4 my-4 rounded-none">
      <div className="absolute inset-0 bg-blue-900/5 transition-opacity duration-1000" />
